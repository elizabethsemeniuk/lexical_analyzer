...
public class C_Sharp {
    ...
    public enum Type {
        ...
        Type_String_class("string\\b"), Type_Ienum("IEnumerable\\b"),Type_Console("Console\\b"),Type_WriteLine("Writeline"),Type_Write("Write"),
        Type_StreamReader("StreamReader\\b"),Type_Dispose("Dispose\\b"),Type_IEnumerator("IEnumerator\\b"),
        // C# marks
